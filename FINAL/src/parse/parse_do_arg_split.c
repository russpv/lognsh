...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   parse_do_arg_split.c                               :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: rpeavey <rpeavey@student.42.fr>            +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/04/10 16:33:30 by rpeavey           #+#    #+#             */
/*   Updated: 2025/04/10 16:33:31 by rpeavey          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
** Quoted nulls resulting from expansions are retained as 
** empty strings, unless part of a non-null expansion word.
** -d'' is -d
